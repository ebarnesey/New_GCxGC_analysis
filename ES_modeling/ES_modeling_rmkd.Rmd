...
rf_slope_test_comparison <- data.frame(pred.best.rf.s, slopemod.test$slope)
rf_slope_train_comparison <- data.frame(pred.best.rf.s.train, slopemod.train$slope)
...
rf_testcomp <- rf_traincomp <- rf_slope_test_comparison %>% 
