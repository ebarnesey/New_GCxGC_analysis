...
ES_for_quant <- ES_withcat %>% 
  dplyr::select(-c(BlobID, Description, Group.Name, Constellation.Name, Inclusion, LRI.I, Library.ID, Library.NIST.ID, Library.Match.Factor, 
                   ...
                   Cal_Point, LRI_diff, unique.analyte, comp.n, pct_of_samp, IS_glm, Func_group_cat, Library.Name))
...
average_slopes %>% 
  ggplot(aes(x = Retention_index, y = log(avg_slope), color = Func_group_cat))+
  geom_point()
