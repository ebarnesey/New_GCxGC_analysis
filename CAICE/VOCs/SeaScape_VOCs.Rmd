...
soa_fig <- M_t_voc_quantcheck %>% 
  ...
  scale_color_manual(name = "Compound Name", labels = c("styrene", "naphthalene", "benzophenone", "monoterpenes", "1-chlorooctane", "beta cyclocitral"), values = c("darkorange2", "grey50", "tomato3", "aquamarine3", "mediumseagreen", "dodgerblue3"))+
...
soatseries1 <- ggarrange(chlor_hb2, soa_fig, heights = c(10, 14), 
          labels = c("A", "B"),
...
soatseries2 <- ggarrange(chlor_hb2, soa_fig.a, soa_fig.b, heights = c(9, 14, 14), 
          labels = c("A", "B", "C"),
