...
btzpool <- chlor_hb_wt2+
  ...
  geom_point(data = btzpool_ssa, aes(x = r_date, y = ng_per_cm3.sum.z, fill = "Benzothiazole Carbon Pool"), color = "red", shape = 23)

btzpool

png("btz_pool1.png", width=8, height=5,
    units="in", res=1000, pointsize=2)
btzpool
dev.off() 
