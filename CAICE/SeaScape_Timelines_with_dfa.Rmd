...
chlor_hb <- ggplot()+
  geom_line(data = bt_sum_bloom3[!is.na(bt_sum_bloom3$Extracted_Chla),], aes(x = r_date, y = Extracted_Chla/max_chla, color = "Chlorophyll"), size = 1.5)+
  geom_line(data = bt_sum_bloom3[!is.na(bt_sum_bloom3$Bulk_HB_updated),], aes(x = r_date, y = Bulk_HB_updated/max_hb, color = "Het. Bact."), size = 1.5)+
...
png("chlorhb1.png", width=7, height=2.5,
    units="in", res=600, pointsize=12)
chlor_hb
dev.off()
...
pp_btz2 <- ggplot(M_t_analyte_withIS.btz) +
  ...
  geom_point(data = btz_voc, aes(x = Date_time, y=(btz_ppt/1000)*coeff2, color = "Benzothiazole - VOC"), size = 3) + # Divide by 10 to get the same range than the temperature
  theme(legend.position = "bottom")+
  xlab("")+
  scale_y_continuous(
    ...
    # Add a second axis and specify its features
    sec.axis = sec_axis(~./coeff2, name="Gas Phase (ppb)")
  )+
  scale_color_manual(values = c("black"))+
...
png("btz_trial2.png", width=11, height=7,
    units="in", res=600, pointsize=12)
pp_btz2
dev.off()
