...
pp_btz2 <- ggplot(M_t_analyte_withIS.btz) +
  ...
  scale_y_continuous(
    ...
    # Features of the first axis
    #name = "Aerosol Concentration \n(ng/m^3)",
    name = expression(Aerosol~Concentration~(ng/m^3)),
    
    # Add a second axis and specify its features
    sec.axis = sec_axis(~./coeff2, name="Gas Phase (ppt)")
  )+
  scale_color_manual(values = c("black"))+
...
btztseries1 <- ggarrange(chlor_hb_wt, pp_btz2, heights = c(9, 16), 
          labels = c("A", "B"),
          ncol = 1, nrow = 2, align = "v")


png("btz_tseries5.png", width=9, height=10,
...
png("btz_tseries_indv3.png", width=6, height=9,
    units="in", res=1000, pointsize=2)
pp_btz_each
dev.off() 
