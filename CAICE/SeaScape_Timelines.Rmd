...
tolycheck <- forcorr_allcomp.zscore.long2t %>% 
...
h.clust.factors.z <- data.frame(cluster = c(1,2,3,4,5,6,7,8), cluster_factors = c("Factor A", "Factor C", "Factor E", "Factor B", "Factor D", "Factor F", "Factor G", "Factor H"), cluster_factor_types = c("Anthroporenic", "Mixed", "Mixed", "Anthropogenic", "Mixed", "Biological", "Biological", "Biological"))
...
pan<- ggplot()+
  ...
  theme_bw()+
  ylab("Factor Abundance\n(Z-Scored)")+
  ggtitle("Anthropogenic Influence Factors")+
  theme(plot.title = element_text(size = 18, hjust = 0.5),legend.text = element_text(size = 16), legend.title = element_blank(), axis.text.x = element_text(size = 18), axis.text.y = element_text(size = 18), axis.title.y = element_text(size = 20))+
  #ylim(minh, maxh)+
  scale_x_datetime(date_breaks = "6 days", labels = date_format("%b %d"))+
  xlab("")+
...
pmix<- ggplot()+
  ...
  theme_bw()+
  ylab("Factor Abundance\n(Z-Scored)")+
  ggtitle("Mixed Influence Factors")+
  theme(plot.title = element_text(size = 18, hjust = 0.5), legend.text = element_text(size = 16), legend.title = element_blank(), axis.text.x = element_text(size = 18), axis.text.y = element_text(size = 18), axis.title.y = element_text(size = 20))+
  #ylim(minh, maxh)+
  scale_x_datetime(date_breaks = "6 days", labels = date_format("%b %d"))+
  xlab("")+
  #guides(fill=guide_legend(nrow=2,byrow=TRUE))+
  scale_color_manual(values = cols[3:5])+
  scale_fill_manual(values = c("darkgreen", "blue4"), labels = c("Peak Chla", "Peak Bacteria"))
...
pbio<- ggplot()+
  ...
  theme_bw()+
  ylab("Factor Abundance\n(Z-Scored)")+
  ggtitle("Biological Influence Factors")+
  theme(plot.title = element_text(size = 18, hjust = 0.5), legend.text = element_text(size = 16), legend.title = element_blank(), axis.text.x = element_text(size = 18), axis.text.y = element_text(size = 18), axis.title.y = element_text(size = 20))+
  #ylim(minh, maxh)+
  scale_x_datetime(date_breaks = "6 days", labels = date_format("%b %d"))+
  xlab("")+
...
chla_hb %>% 
  ...
  theme_bw()+
  scale_color_manual(values = c("green3", "blue2"))+
  ylab("Normalized Concentration")+
  theme(plot.title = element_text(size = 18, hjust = 0.5), legend.text = element_text(size = 16), legend.title = element_blank(), axis.text.x = element_text(size = 18), axis.text.y = element_blank(), axis.title.y = element_text(size = 20))+
  #ylim(minh, maxh)+
  scale_x_datetime(date_breaks = "6 days", labels = date_format("%b %d"))+
...
h.clust.factors <- data.frame(cluster_combined = as.factor(c(1,2,3,4,5,6,7,8)), cluster_factors = c("Factor A", "Factor C", "Factor E", "Factor B", "Factor D", "Factor F", "Factor G", "Factor H"), cluster_factor_types = c("Anthroporenic", "Mixed", "Mixed", "Anthropogenic", "Mixed", "Biological", "Biological", "Biological"))
...
M_t_analyte_withIS.hclust %>% 
  ...
  theme(legend.title = element_blank())+
  xlab("")+
  ylab("Fraction Submicron Organic Signal")+
  theme(legend.text = element_text(size = 14), legend.title = element_blank(), axis.text.x = element_text(size = 14), axis.text.y = element_text(size = 14), axis.title.y = element_text(size = 16))+
  scale_x_datetime(date_breaks = "6 days", labels = date_format("%b %d"))
