...
IOP1_nmf2 <- nmf(nnmf_matrix_top90_iop1, 5)

IOP2_nmf2 <- nmf(nnmf_matrix_top90_iop2, 5)
...
IOP1_nmf_factor_timelines %>% ggplot(aes(x = iop1_rdates, y = X1), color = "red")+
  geom_line()+
...
IOP2_nmf_factor_timelines %>% ggplot(aes(x = iop2_rdates, y = X1), color = "red")+
  geom_line()+
...
factors_iop1_long <- factors_iop1 %>% 
  gather(nmf_factor, quantity, X1:X5,factor_key = TRUE)
